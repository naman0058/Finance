...
@Component({
  selector: 'app-budget-circular',
  templateUrl: './budget-circular.component.html',
  styleUrls: ['./budget-circular.component.css']
})
export class BudgetCircularComponent implements OnInit {
